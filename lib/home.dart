...
final filterController1 = StreamController<String>();
final filterController2 = StreamController<String>();
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: StreamBuilder(
          stream: dropdownValue == 'TABLE TENNIS'
                  ...
                  : dateFilter == 'Yesterday'
                      ...
                      : dateFilter == 'Tommorow'
                          ? FirebaseFirestore.instance
                              .collection('sportsCard')
                              .where('date',
                                  isEqualTo: format.format(tomFilter))
                              .snapshots()
                          : FirebaseFirestore.instance
                              .collection('sportsCard')
